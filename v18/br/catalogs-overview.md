...
[Tabela 52.1][(catalogs-overview.md#CATALOG-TABLE "Table 52.1. System Catalogs")] lista os catálogos do sistema. Mais documentação detalhada de cada catálogo segue abaixo.
...
<td>métodos de acesso de relações</td>
</tr>
<tr>
<td>
...
<td>operadores de métodos de acesso</td>
</tr>
<tr>
<td>
...
<td>funções de suporte para métodos de acesso</td>
</tr>
<tr>
<td>
...
<td>valores padrão da coluna</td>
</tr>
<tr>
<td>
...
<td>colunas da tabela (<span class="quote">“<span class="quote">atributos</span>”</span>)</td>
</tr>
<tr>
<td>
...
<td>identificadores de autorização ( papéis)</td>
</tr>
<tr>
<td>
...
<td>identificador de autorização relações de filiação</td>
</tr>
<tr>
<td>
...
<td>casts (conversões de tipos de dados)</td>
</tr>
<tr>
<td>
...
<td>tabelas, índices, sequências, visualizações (<span class="quote">“<span class="quote">relações</span>”</span>)</td>
</tr>
<tr>
<td>
...
<td>colunações (informações de localização)</td>
</tr>
<tr>
<td>
...
<td>restrições de verificação, restrições únicas, restrições de chave primária, restrições de chave estrangeira</td>
</tr>
<tr>
<td>
...
<td>informações de conversão de codificação</td>
</tr>
<tr>
<td>
...
<td>bases de dados dentro deste clúster de bases de dados</td>
</tr>
<tr>
<td>
...
<td>configurações por papel e por banco de dados</td>
</tr>
<tr>
<td>
...
<td>privilegios padrão para tipos de objeto</td>
</tr>
<tr>
<td>
...
<td>dependências entre objetos do banco de dados</td>
</tr>
<tr>
<td>
...
<td>descrições ou comentários sobre objetos de banco de dados</td>
</tr>
<tr>
<td>
...
<td>definições de rótulo e valor de enum</td>
</tr>
<tr>
<td>
...
<td>definições de wrappers de dados estrangeiros</td>
</tr>
<tr>
<td>
...
<td>definições de servidores estrangeiros</td>
</tr>
<tr>
<td>
...
<td>informações adicionais sobre a mesa estrangeira</td>
</tr>
<tr>
<td>
...
<td>informações adicionais do índice</td>
</tr>
<tr>
<td>
...
<td>hierarquia de herança de tabela</td>
</tr>
<tr>
<td>
...
<td>privilégios iniciais do objeto</td>
</tr>
<tr>
<td>
...
<td>linguagens para escrever funções</td>
</tr>
<tr>
<td>
...
<td>páginas de dados para objetos grandes</td>
</tr>
<tr>
<td>
...
<td>metadados para objetos grandes</td>
</tr>
<tr>
<td>
...
<td>classes de operadores de método de acesso</td>
</tr>
<tr>
<td>
...
<td>métodos de acesso famílias de operadores</td>
</tr>
<tr>
<td>
...
<td>parâmetros de configuração para os quais foram concedidos privilégios</td>
</tr>
<tr>
<td>
...
<td>informações sobre a chave de partição das tabelas</td>
</tr>
<tr>
<td>
...
<td>políticas de segurança de linha</td>
</tr>
<tr>
<td>
...
<td>publicações para replicação lógica</td>
</tr>
<tr>
<td>
...
<td>esquema para mapeamento de publicação</td>
</tr>
<tr>
<td>
...
<td>relação com mapeamento de publicação</td>
</tr>
<tr>
<td>
...
<td>informações sobre os tipos de alcance</td>
</tr>
<tr>
<td>
...
<td>origens de replicação registradas</td>
</tr>
<tr>
<td>
...
<td>regras de reescrita de consultas</td>
</tr>
<tr>
<td>
...
<td>etiquetas de segurança em objetos de banco de dados</td>
</tr>
<tr>
<td>
...
<td>informações sobre sequências</td>
</tr>
<tr>
<td>
...
<td>dependências em objetos compartilhados</td>
</tr>
<tr>
<td>
...
<td>comentários sobre objetos compartilhados</td>
</tr>
<tr>
<td>
...
<td>etiquetas de segurança em objetos de banco de dados compartilhados</td>
</tr>
<tr>
<td>
...
<td>estatísticas do planejador</td>
</tr>
<tr>
<td>
...
<td>estatísticas de planejador estendido (definição)</td>
</tr>
<tr>
<td>
...
<td>estatísticas de planejador estendido (estatísticas construídas)</td>
</tr>
<tr>
<td>
...
<td>assinaturas de replicação lógica</td>
</tr>
<tr>
<td>
...
<td>estado de relação para assinaturas</td>
</tr>
<tr>
<td>
...
<td>espaços de tabela dentro deste clúster de banco de dados</td>
</tr>
<tr>
<td>
...
<td>transforma (conversão de tipo de dados para linguagem procedural)</td>
</tr>
<tr>
<td>
...
<td>configurações de pesquisa de texto</td>
</tr>
<tr>
<td>
...
<td>mapas de correspondência de tokens das configurações de pesquisa de texto</td>
</tr>
<tr>
<td>
...
<td>dicionários de busca de texto</td>
</tr>
<tr>
<td>
...
<td>parâmetros de busca de texto</td>
</tr>
<tr>
<td>
...
<td>modelos de pesquisa de texto</td>
</tr>
<tr>
<td>
...
<td>mapas de usuários para servidores estrangeiros</td>
</tr>
</tbody>
</table>
