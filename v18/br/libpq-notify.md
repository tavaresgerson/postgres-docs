...
[Exemplo 32.2][(libpq-example.md#LIBPQ-EXAMPLE-2 "Example 32.2. libpq Example Program 2")] fornece um programa de amostra que ilustra o uso de notificação assíncrona.
