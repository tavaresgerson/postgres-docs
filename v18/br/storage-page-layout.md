...
[Tabela 66.2][(storage-page-layout.md#PAGE-TABLE "Table 66.2. Overall Page Layout")] mostra o layout geral de uma página. Há cinco partes em cada página.
...
<td>Com 24 bytes de comprimento. Contém informações gerais sobre a página, incluindo ponteiros de espaço livre.</td>
</tr>
<tr>
<td>
    ItemIdData
   </td>
<td>Matriz de identificadores de itens que apontam para os itens reais. Cada entrada é um par (deslocamento, comprimento). 4 bytes por item.</td>
</tr>
<tr>
<td>
    Free space
   </td>
<td>O espaço não alocado. Novos identificadores de itens são alocados a partir do início desta área, novos itens a partir do final.</td>
</tr>
<tr>
<td>
    Items
   </td>
<td>Os próprios itens.</td>
</tr>
<tr>
<td>
    Special space
   </td>
<td>Dados específicos do método de acesso ao índice. Diferentes métodos armazenam dados diferentes. Vazio em tabelas comuns.</td>
</tr>
</tbody>
</table>
...
<td>LSN: próximo byte após o último byte do registro WAL para a última alteração</td>
</tr>
<tr>
<td>
    pd_checksum
...
<td>Deslocamento para o início do espaço livre</td>
</tr>
<tr>
<td>
    pd_upper
...
<td>Deslocamento até o fim do espaço livre</td>
</tr>
<tr>
<td>
    pd_special
...
<td>Deslocamento para o início do espaço especial</td>
</tr>
<tr>
<td>
    pd_pagesize_version
...
<td>Tamanho da página e informações sobre o número da versão do layout</td>
</tr>
<tr>
<td>
    pd_prune_xid
...
<td>Mais antigo XMAX não podado na página, ou zero se nenhum</td>
</tr>
</tbody>
</table>
...
<td>inserir e/ou excluir o carimbo CID (sobreposição com t_xvac)</td>
</tr>
<tr>
<td>
    t_xvac
...
<td>XID para operação VACUUM que move uma versão de linha</td>
</tr>
<tr>
<td>
    t_ctid
...
<td>TID atual desta ou versão mais nova da linha</td>
</tr>
<tr>
<td>
    t_infomask2
...
<td>número de atributos, além de vários bits de bandeira</td>
</tr>
<tr>
<td>
    t_infomask
...
<td>variosos bits de bandeira</td>
</tr>
<tr>
<td>
    t_hoff
...
<td>deslocamento para dados do usuário</td>
</tr>
</tbody>
</table>
