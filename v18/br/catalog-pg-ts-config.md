...
<p>Nome da configuração de pesquisa de texto</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O OID do espaço de nome que contém essa configuração</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Proprietário da configuração</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<code class="type">
      oid
     </code>(referências<a class="link" href="catalog-pg-ts-parser.md" title="52.62. pg_ts_parser">
<code class="structname">
       pg_ts_parser
      </code>
</a>
...
<p>O OID do analisador de busca de texto para esta configuração</p>
</td>
</tr>
</tbody>
</table>
