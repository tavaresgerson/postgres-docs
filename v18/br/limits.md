...
[Tabela K.1][(limits.md#LIMITS-TABLE "Table K.1. PostgreSQL Limitations")] descreve vários limites rígidos do PostgreSQL. No entanto, limites práticos, como limitações de desempenho ou espaço em disco disponível, podem ser aplicados antes que os limites rígidos absolutos sejam alcançados.
...
<tr>
<td>número de bancos de dados</td>
<td>
    4,294,950,911
   </td>
<td>
...
<tr>
<td>relações por banco de dados</td>
<td>
    1,431,650,303
   </td>
<td>
...
<tr>
<td>tamanho da relação</td>
<td>
    32 TB
   </td>
<td>com o padrão<code class="symbol">
     BLCKSZ
    </code>de 8192 bytes</td>
</tr>
<tr>
<td>linhas por tabela</td>
<td>
...
<tr>
<td>colunas por tabela</td>
<td>
    1,600
   </td>
<td>mais limitada pela adequação do tamanho do tuple em uma única página; veja a nota abaixo</td>
</tr>
<tr>
<td>colunas em um conjunto de resultados</td>
<td>
    1,664
   </td>
<td>
...
<tr>
<td>índice por tabela</td>
<td>
    unlimited
   </td>
<td>limitado por relações máximas por banco de dados</td>
</tr>
<tr>
<td>colunas por índice</td>
<td>
    32
   </td>
<td>pode ser aumentada recompilando<span class="productname">PostgreSQL</span>
</td>
</tr>
<tr>
<td>chaves de partição</td>
<td>
    32
   </td>
<td>pode ser aumentada recompilando<span class="productname">PostgreSQL</span>
...
<tr>
<td>comprimento do identificador</td>
<td>
    63 bytes
   </td>
<td>pode ser aumentada recompilando<span class="productname">PostgreSQL</span>
