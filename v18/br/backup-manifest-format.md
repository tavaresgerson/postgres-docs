...
O manifesto de backup gerado por [pg_basebackup](app-pgbasebackup.md) é destinado principalmente a permitir que o backup seja verificado usando [pg_verifybackup](app-pgverifybackup.md). No entanto, também é possível que outras ferramentas leiam o arquivo do manifesto de backup e usem as informações contidas nele para seus próprios propósitos. Para esse fim, este capítulo descreve o formato do arquivo do manifesto de backup.
