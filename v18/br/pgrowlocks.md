...
O parâmetro é o nome de uma tabela. O resultado é um conjunto de registros, com uma linha para cada linha bloqueada na tabela. As colunas de saída são mostradas em [Tabela F.21][(pgrowlocks.md#PGROWLOCKS-COLUMNS "Table F.21. pgrowlocks Output Columns")].
...
<td>ID do par (TID) da linha bloqueada</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>ID de transação do armário, ou ID multixact se for multitransação; veja<a class="xref" href="transaction-id.md" title="67.1. Transactions and Identifiers">Seção 67.1</a>
</td>
</tr>
<tr>
<td>
...
<td>Verdadeiro se o armário é uma multitransação</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>ID de transação dos armários (mais de um, se for multitransação)</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Modo de bloqueio dos armários (mais de um, se for multitransação), uma matriz de<code class="literal">
     For Key Share
...
<td>IDs de processo de backends de bloqueio (mais de um, se for multitransação)</td>
</tr>
</tbody>
</table>
