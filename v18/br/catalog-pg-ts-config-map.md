...
<code class="type">
      oid
     </code>(referências<a class="link" href="catalog-pg-ts-config.md" title="52.59. pg_ts_config">
...
<p>O OID do<a class="link" href="catalog-pg-ts-config.md" title="52.59. pg_ts_config">
<code class="structname">
       pg_ts_config
      </code>
</a>entrada que possui esta entrada do mapa</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Um tipo de token emitido pelo analisador da configuração</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Ordem em que consultar esta entrada (inferior<code class="structfield">
      mapseqno
     </code>primeiro)</p>
</td>
</tr>
...
<code class="type">
      oid
     </code>(referências<a class="link" href="catalog-pg-ts-dict.md" title="52.61. pg_ts_dict">
<code class="structname">
       pg_ts_dict
      </code>
</a>
...
<p>O OID do dicionário de busca de texto a ser consultado</p>
</td>
</tr>
</tbody>
</table>
