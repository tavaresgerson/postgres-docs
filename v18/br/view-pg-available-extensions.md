...
<p>Nome da versão padrão, ou<code class="literal">
      NULL
     </code>se não for especificado</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Atualmente, a versão instalada da extensão, ou<code class="literal">
      NULL
     </code>se não estiver instalado</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
