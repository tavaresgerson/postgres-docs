...
Você usa o comando [DELETE](sql-delete.md) para remover linhas; a sintaxe é muito semelhante ao comando [UPDATE](sql-update.md). Por exemplo, para remover todas as linhas da tabela de produtos que têm um preço de 10, use:
