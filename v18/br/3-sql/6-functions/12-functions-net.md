 ...
 <tbody>
  <tr>
   <td class="func_table_entry">
    ...
    <p>
     Define os últimos 3 bytes do endereço como zero. O prefixo restante pode ser associado a um fabricante específico (usando dados não incluídos na
  ...
  <tr>
   <td class="func_table_entry">
    ...
    <p>
     Define os últimos 5 bytes do endereço como zero. O prefixo restante pode ser associado a um fabricante específico (usando dados não incluídos na
     <span class="productname">
      PostgreSQL
     </span>
     ).
