...
Observe que as entradas para ambas as funções na visualização fazem referência ao nome “específico” da rotina, mesmo que os nomes das colunas sejam usados de uma maneira inconsistente com outras visualizações do esquema de informações sobre rotinas. Isso é de acordo com o padrão SQL, embora seja, sem dúvida, um mau projeto. Consulte [Seção 35.45][(infoschema-routines.md "35.45. routines")] para obter mais informações sobre nomes específicos.
