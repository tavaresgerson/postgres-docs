...
* [libpq](libpq.md) é incluído porque é a principal interface em linguagem C, e porque muitas outras interfaces de cliente são construídas sobre ela.
* [ECPG](ecpg.md) é incluído porque depende da gramática SQL do lado do servidor, e, portanto, é sensível a mudanças no PostgreSQL em si.
