...
O aplicativo [pg_checksums](app-pgchecksums.md) pode ser usado para habilitar ou desabilitar verificações de checksum de dados, bem como para verificar verificações de checksum, em um clúster offline.