...
Observe que o login anônimo/pseudônimo também é possível, habilitando a delegação do usermap; veja [Seção 50.1.3](oauth-validator-design.md#OAUTH-VALIDATOR-DESIGN-USERMAP-DELEGATION)).
