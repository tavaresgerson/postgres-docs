...
O catálogo `pg_extension` armazena informações sobre as extensões instaladas. Consulte [Seção 36.17][(extend-extensions.md "36.17. Packaging Related Objects into an Extension")] para obter detalhes sobre as extensões.
...
<p>Esquema contendo os objetos exportados do extensivo</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Verdadeiro se a extensão pode ser realocada para outro esquema</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Nome da versão para a extensão</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Conjunto de<code class="type">
      regclass
     </code>IDOs para a(s) tabela(s) de configuração da extensão, ou<code class="literal">
      NULL
     </code>se nenhum</p>
</td>
</tr>
...
<p>Conjunto de<code class="literal">
      WHERE
     </code>- condições de filtro de cláusula para a(s) tabela(s) de configuração da extensão, ou<code class="literal">
      NULL
     </code>se nenhum</p>
</td>
</tr>
