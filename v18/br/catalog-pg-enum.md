...
<p>O OID do<a class="link" href="catalog-pg-type.md" title="52.64. pg_type">
<code class="structname">
       pg_type
      </code>
</a>entrada que possui esse valor do enum</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>A posição de classificação deste valor do enum dentro do seu tipo de enum</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O rótulo textual para este valor do enum</p>
</td>
</tr>
</tbody>
</table>
