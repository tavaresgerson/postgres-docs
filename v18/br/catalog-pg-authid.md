...
<p>O papel tem privilégios de superusuário</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O papel herda automaticamente os privilégios dos papéis dos quais é membro</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O papel pode criar mais papéis</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Role pode criar bancos de dados</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O papel pode fazer login. Ou seja, esse papel pode ser dado como o identificador de autorização da sessão inicial.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O papel é um papel de replicação. Um papel de replicação pode iniciar conexões de replicação e criar e descartar slots de replicação.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O papel contorna todas as políticas de segurança de nível de linha, veja<a class="xref" href="ddl-rowsecurity.md" title="5.9. Row Security Policies">Seção 5.9</a>para mais informações.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Para os papéis que podem fazer login, isso define o número máximo de conexões concorrentes que esse papel pode fazer. -1 significa sem limite.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Senha criptografada; nulo se não houver. O formato depende da forma de criptografia utilizada.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Tempo de expiração da senha (usado apenas para autenticação de senha); nulo se não houver expiração</p>
</td>
</tr>
</tbody>
</table>
