...
<p>O tipo de objeto ao qual este rótulo se aplica, como texto.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O OID do espaço de nome para este objeto, se aplicável; caso contrário, NULL.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O nome do objeto ao qual este rótulo se aplica, como texto.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<code class="type">
      text
     </code>(referências<a class="link" href="catalog-pg-seclabel.md" title="52.46. pg_seclabel">
<code class="structname">
       pg_seclabel
      </code>
</a>
