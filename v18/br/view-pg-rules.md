...
<p>Nome da tabela para a qual a regra é aplicada</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<code class="type">
      name
     </code>(referências<a class="link" href="catalog-pg-rewrite.md" title="52.45. pg_rewrite">
<code class="structname">
       pg_rewrite
      </code>
</a>
...
<p>Definição de regra (um comando de criação reconstruído)</p>
</td>
</tr>
</tbody>
</table>
