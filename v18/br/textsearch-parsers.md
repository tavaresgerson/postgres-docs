...
O analisador embutido é chamado `pg_catalog.default`. Ele reconhece 23 tipos de tokens, mostrados na [Tabela 12.1][(textsearch-parsers.md#TEXTSEARCH-DEFAULT-PARSER "Table 12.1. Default Parser's Token Types")].
...
<td>Palavra, todas as letras ASCII</td>
<td>
<code class="literal">
     elephant
    </code>
...
<td>Palavras, letras e algarismos</td>
<td>
<code class="literal">
     beta1
    </code>
...
<td>Palavra hífena, todo ASCII</td>
<td>
<code class="literal">
     up-to-date
    </code>
...
<td>Palavra hífena, todas as letras</td>
<td>
<code class="literal">
     lógico-matemática
    </code>
...
<td>Palavras compostas, letras e algarismos</td>
<td>
<code class="literal">
     postgresql-beta1
    </code>
...
<td>Parte de palavra com hífen, todo ASCII</td>
<td>
<code class="literal">
     postgresql
    </code>
...
<td>Parte de palavra com hífen, todas as letras</td>
<td>
<code class="literal">
     lógico
    </code>
...
<td>Parte de palavra com hífen, letras e dígitos</td>
<td>
<code class="literal">
     beta1
    </code>
...
<td>Nome do arquivo ou caminho</td>
<td>
<code class="literal">
     /usr/local/foo.txt
    </code>
