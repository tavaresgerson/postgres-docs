...
<p>A expressão padrão ou de geração da coluna, em<code class="function">
      nodeToString()
     </code>representação. Use<code class="literal">
      pg_get_expr(adbin, adrelid)
     </code>para convertê-lo em uma expressão SQL.</p>
</td>
</tr>
</tbody>
</table>
