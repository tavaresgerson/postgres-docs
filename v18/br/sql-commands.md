...
Esta parte contém informações de referência para os comandos SQL suportados pelo PostgreSQL. Por “SQL”, a linguagem é geralmente entendida; informações sobre a conformidade e compatibilidade dos padrões de cada comando podem ser encontradas na página de referência respectiva.
