...
Os operadores de comparação comuns estão disponíveis, conforme mostrado na Tabela 9.1 [(functions-comparison.md#FUNCTIONS-COMPARISON-OP-TABLE "Table 9.1. Comparison Operators")].
...
Existem também alguns predicados de comparação, conforme mostrado na [Tabela 9.2][(functions-comparison.md#FUNCTIONS-COMPARISON-PRED-TABLE "Table 9.2. Comparison Predicates")]. Esses se comportam de maneira muito semelhante aos operadores, mas têm uma sintaxe especial exigida pelo padrão SQL.
...
<p class="func_signature">Predicado</p>
<p>Descrição</p>
<p>Exemplo(s)</p>
</th>
</tr>
...
<p>Entre (incluindo os pontos finais da faixa).</p>
<p>
<code class="literal">
      2 BETWEEN 1 AND 3
...
<p>Não entre (a negação de<code class="literal">
      BETWEEN
     </code>
     ).
    </p>
...
<p>Entre, após a classificação dos dois valores de extremidade.</p>
<p>
<code class="literal">
...
<p>Não entre, após a classificação dos dois valores de extremidade.</p>
<p>
<code class="literal">
...
<p>Não é igual, tratando o nulo como um valor comparável.</p>
<p>
<code class="literal">
      1 IS DISTINCT FROM NULL
     </code>→<code class="returnvalue">
      t
     </code>(em vez de<code class="literal">
      NULL
     </code>)</p>
<p>
<code class="literal">
...
<p>Igual, tratando o nulo como um valor comparável.</p>
<p>
<code class="literal">
...
<p>Teste se o valor não é nulo.</p>
<p>
<code class="literal">
      'null' IS NOT NULL
     </code>→<code class="returnvalue">
...
<p>Teste se o valor é nulo (sintaxe não padrão).</p>
</td>
</tr>
<tr>
<td class="func_table_entry">
...
<p>Teste se o valor não é nulo (sintaxe não padrão).</p>
</td>
</tr>
<tr>
<td class="func_table_entry">
...
<p>Teste se a expressão booleana produz verdadeiro.</p>
<p>
<code class="literal">
      true IS TRUE
     </code>→<code class="returnvalue">
...
<p>Teste se a expressão booleana gera falso ou desconhecido.</p>
<p>
<code class="literal">
      true IS NOT TRUE
     </code>→<code class="returnvalue">
...
<p>Teste se a expressão booleana gera um valor falso.</p>
<p>
<code class="literal">
      true IS FALSE
     </code>→<code class="returnvalue">
...
<p>Teste se a expressão booleana produz verdadeiro ou desconhecido.</p>
<p>
<code class="literal">
      true IS NOT FALSE
     </code>→<code class="returnvalue">
...
<p>Teste se a expressão booleana gera desconhecido.</p>
<p>
<code class="literal">
      true IS UNKNOWN
     </code>→<code class="returnvalue">
...
<p>Teste se a expressão booleana produz verdadeiro ou falso.</p>
<p>
<code class="literal">
      true IS NOT UNKNOWN
     </code>→<code class="returnvalue">
...
Algumas funções relacionadas à comparação também estão disponíveis, conforme mostrado na [Tabela 9.3][(functions-comparison.md#FUNCTIONS-COMPARISON-FUNC-TABLE "Table 9.3. Comparison Functions")].
...
<p>Retorna o número de argumentos que não são nulos.</p>
<p>
<code class="literal">
...
<p>Retorna o número de argumentos nulos.</p>
<p>
<code class="literal">
      num_nulls(1, NULL, 2)
     </code>→<code class="returnvalue">
