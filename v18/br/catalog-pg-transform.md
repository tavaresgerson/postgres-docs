...
<p>OID do tipo de dados para o qual essa transformação é feita</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>OID da língua para a qual essa transformação é feita</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O OID da função a ser usada ao converter o tipo de dados para o idioma processual (por exemplo, parâmetros da função). O valor zero é armazenado se o comportamento padrão deve ser usado.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O OID da função a ser usada ao converter a saída do idioma procedural (por exemplo, valores de retorno) para o tipo de dados. Zero é armazenado se o comportamento padrão deve ser usado.</p>
</td>
</tr>
</tbody>
</table>
