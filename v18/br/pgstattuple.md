...
As colunas de saída são descritas em [Tabela F.24][(pgstattuple.md#PGSTATTUPLE-COLUMNS "Table F.24. pgstattuple Output Columns")].
...
<td>Comprimento da relação física em bytes</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Total comprimento de tuplas vivas em bytes</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Porcentagem de tuplas vivas</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Total comprimento de tuplas mortas em bytes</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Porcentagem de tuplas mortas</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Espaço livre total em bytes</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Porcentagem de espaço livre</td>
</tr>
</tbody>
</table>
...
<td>Número da versão da árvore B</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Nível da árvore da página inicial</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Tamanho total do índice em bytes</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Localização da página raiz (zero se nenhuma)</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de<span class="quote">“<span class="quote">interno</span>”</span>(páginas de nível superior)</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de páginas de folha</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de páginas vazias</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de páginas excluídas</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Densidade média das páginas de folha</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Fragmentação de página de folha</td>
</tr>
</tbody>
</table>
...
O `index_size` relatado normalmente corresponderá a uma página a mais do que a contabilizada pelo `internal_pages + leaf_pages +
    empty_pages + deleted_pages`, porque também inclui a metapágina do índice.
...
:   Isto é o mesmo que `pgstatindex(regclass)`, exceto que o índice alvo é especificado como TEXT. Esta função é mantida devido à compatibilidade reversa até agora, e será descontinuada em alguma versão futura.

`pgstatginindex(regclass) returns record`
:   `pgstatginindex` retorna um registro que mostra informações sobre um índice GIN. Por exemplo:
...
<td>Número de páginas na lista pendente</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de tuplas na lista pendente</td>
</tr>
</tbody>
</table>
...
:   `pgstathashindex` retorna um registro que mostra informações sobre um índice HASH. Por exemplo:
...
<td>Número de páginas do balde</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de páginas de sobreposição</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de páginas em bitmap</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de páginas não utilizadas</td>
</tr>
<tr>
<td>
<code class="structfield">
...
:   Isto é o mesmo que `pg_relpages(regclass)`, exceto que a relação alvo é especificada como TEXT. Esta função é mantida devido à compatibilidade reversa até agora, e será descontinuada em alguma versão futura.

`pgstattuple_approx(regclass) returns record` é uma alternativa mais rápida a
    `pgstattuple` que retorna resultados aproximados.
    O argumento é o nome ou OID da relação de destino.
    Por exemplo:
...
As colunas de saída são descritas em [Tabela F.25][(pgstattuple.md#PGSTATAPPROX-COLUMNS "Table F.25. pgstattuple_approx Output Columns")].
...
<td>Comprimento da relação física em bytes (exato)</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Porcentagem de tabela escaneada</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de tuplas vivas (estimação)</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Total comprimento de tuplas vivas em bytes (estimação)</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Número de tuplas mortas (exato)</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Total comprimento de tuplas mortas em bytes (exato)</td>
</tr>
<tr>
<td>
<code class="structfield">
...
<td>Espaço livre total em bytes (estimativa)</td>
</tr>
<tr>
<td>
<code class="structfield">
