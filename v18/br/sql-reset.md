...
*`configuration_parameter`*: Nome de um parâmetro de execução configurável. Os parâmetros disponíveis estão documentados no [Capítulo 19][(runtime-config.md "Chapter 19. Server Configuration")] e na página de referência [SET][(sql-set.md "SET")].
