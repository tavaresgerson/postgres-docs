...
<p>OID de uma função de manipulador que é responsável por fornecer informações sobre o método de acesso</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<code class="literal">
      t
     </code>= tabela (incluindo visualizações materializadas),<code class="literal">
      i
     </code>= índice.</p>
</td>
</tr>
