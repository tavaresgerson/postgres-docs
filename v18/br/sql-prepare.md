...
Para mais informações sobre o planejamento de consultas e as estatísticas coletadas pelo PostgreSQL para esse propósito, consulte a documentação do [ANALYZE](sql-analyze.md).
