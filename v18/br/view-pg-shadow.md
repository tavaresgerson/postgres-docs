...
<p>Senha criptografada; nulo se não houver. Veja<a class="link" href="catalog-pg-authid.md" title="52.8. pg_authid">
<code class="structname">
       pg_authid
      </code>
</a>para obter detalhes sobre como as senhas criptografadas são armazenadas.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
