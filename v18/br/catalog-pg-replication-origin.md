...
O catálogo `pg_replication_origin` contém todas as origens de replicação criadas. Para mais informações sobre as origens de replicação, consulte o Capítulo 48 [(replication-origins.md "Chapter 48. Replication Progress Tracking")].
...
<p>Um identificador único, para todo o conjunto de réplica, para a origem da replicação. Nunca deve sair do sistema.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O nome externo, definido pelo usuário, de uma origem de replicação.</p>
</td>
</tr>
</tbody>
</table>
