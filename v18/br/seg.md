...
Em [Tabela F.29][(seg.md#SEG-REPR-TABLE "Table F.29. seg External Representations")], *`x`*, *`y`* e *`delta`* denotam números em ponto flutuante. *`x`* e *`y`*, mas não *`delta`*, podem ser precedidos por um indicador de certeza.
...
<td>Valor único (intervalo de comprimento zero)</td>
</tr>
<tr>
<td>
<code class="literal">
...
<td>Intervalo de<em class="replaceable">
<code>
      x
     </code>
</em>para<em class="replaceable">
<code>
      y
     </code>
</em>
...
<td>Intervalo aberto com limite inferior<em class="replaceable">
<code>
      x
     </code>
</em>
...
<td>Intervalo aberto com limite superior<em class="replaceable">
<code>
      x
     </code>
</em>
...
<td>Cria um segmento de comprimento zero (um ponto, se quiser)</td>
</tr>
<tr>
<td>
<code class="literal">
...
<td>Cria um segmento de comprimento zero e registra<code class="literal">
     ~
    </code>nos dados.<code class="literal">
     ~
    </code>é ignorado
por
<code class="type">
     seg
    </code>operações, mas é preservado como um comentário.</td>
</tr>
<tr>
<td>
<code class="literal">
...
<td>Cria um ponto em 5,0.<code class="literal">
     &lt;
    </code>é ignorado, mas é preservado como um comentário.</td>
</tr>
<tr>
<td>
<code class="literal">
...
<td>Cria um intervalo<code class="literal">
     4.7 .. 5.3
    </code>. Observe que o<code class="literal">
     (+-)
    </code>a notação não é preservada.</td>
</tr>
<tr>
<td>
<code class="literal">
...
<td>Tudo o que é maior ou igual a 50</td>
</tr>
<tr>
<td>
<code class="literal">
...
<td>Tudo o que é menor ou igual a 0</td>
</tr>
<tr>
<td>
<code class="literal">
...
<td>O mesmo que<code class="literal">
     1...2
    </code>, ou<code class="literal">
     1 .. 2
    </code>, ou<code class="literal">
     1..2
    </code>(espaços ao redor do operador de intervalo são ignorados)</td>
</tr>
</tbody>
</table>
...
O módulo `seg` inclui uma classe de operador de índice GiST para valores de `seg`. Os operadores suportados pela classe de operador GiST são mostrados na [Tabela F.31][(seg.md#SEG-GIST-OPERATORS "Table F.31. Seg GiST Operators")].
...
<p>É o primeiro<code class="type">
      seg
     </code>completamente à esquerda da segunda? [a, b] &lt;&lt; [c, d] é verdadeiro se b &lt; c.</p>
</td>
</tr>
<tr>
<td class="func_table_entry">
...
<p>É o primeiro<code class="type">
      seg
     </code>completamente à direita da segunda? [a, b] &gt;&gt; [c, d] é verdadeiro se a &gt; d.</p>
</td>
</tr>
<tr>
<td class="func_table_entry">
...
<p>O primeiro<code class="type">
      seg
     </code>Não se estende ao direito do segundo? [a, b] &amp;&lt; [c, d] é verdadeiro se b &lt;= d.</p>
</td>
</tr>
<tr>
<td class="func_table_entry">
...
<p>O primeiro<code class="type">
      seg
     </code>não se estenda à esquerda da segunda? [a, b] &amp;&gt; [c, d] é verdadeiro se a &gt;= c.</p>
</td>
</tr>
<tr>
<td class="func_table_entry">
...
Além dos operadores de comparação acima, os operadores de comparação comuns mostrados em [Tabela 9.1] [(functions-comparison.md#FUNCTIONS-COMPARISON-OP-TABLE "Table 9.1. Comparison Operators")] estão disponíveis para o tipo `seg`. Esses operadores primeiro comparam (a) com (c), e se esses forem iguais, comparam (b) com (d). Isso resulta em uma classificação razoavelmente boa na maioria dos casos, o que é útil se você quiser usar ORDER BY com esse tipo.
