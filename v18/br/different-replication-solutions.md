...
PostgreSQL não oferece esse tipo de replicação, embora o PostgreSQL com dois estágios de compromisso ([PREPARE TRANSACTION][(sql-prepare-transaction.md "PREPARE TRANSACTION")] e [COMMIT PREPARED][(sql-commit-prepared.md "COMMIT PREPARED")]) possa ser usado para implementar isso no código de aplicativo ou no middleware.

[Tabela 26.1][(different-replication-solutions.md#HIGH-AVAILABILITY-MATRIX "Table 26.1. High Availability, Load Balancing, and Replication Feature Matrix")] resume as capacidades das várias soluções listadas acima.
...
<tr>
<td>Não é necessário hardware especial</td>
<td align="center">
</td>
<td align="center">
    •
...
<tr>
<td>Permite múltiplos servidores primários</td>
<td align="center">
</td>
<td align="center">
</td>
...
<tr>
<td>Sem sobrecarga no primário</td>
<td align="center">
    •
   </td>
<td align="center">
...
<tr>
<td>Sem esperar por vários servidores</td>
<td align="center">
    •
   </td>
<td align="center">
...
<tr>
<td>A falha primária nunca perderá dados</td>
<td align="center">
    •
   </td>
<td align="center">
...
<tr>
<td>As réplicas aceitam consultas somente de leitura</td>
<td align="center">
</td>
<td align="center">
</td>
...
<tr>
<td>Granularidade por tabela</td>
<td align="center">
</td>
<td align="center">
</td>
...
<tr>
<td>Nenhuma resolução de conflito necessária</td>
<td align="center">
    •
   </td>
<td align="center">
