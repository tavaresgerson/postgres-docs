...
Os índices de múltiplas colunas devem ser usados com parcimônia. Na maioria das situações, um índice em uma única coluna é suficiente e economiza espaço e tempo. É improvável que índices com mais de três colunas sejam úteis, a menos que o uso da tabela seja extremamente estilizado. Veja também [Seção 11.5][(indexes-bitmap-scans.md "11.5. Combining Multiple Indexes")] e [Seção 11.9][(indexes-index-only-scans.md "11.9. Index-Only Scans and Covering Indexes")] para uma discussão sobre os méritos das diferentes configurações de índice.