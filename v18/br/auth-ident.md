...
Quando o ident é especificado para uma conexão local (não TCP/IP), a autenticação de pares (consulte [Seção 20.9][(auth-peer.md "20.9. Peer Authentication")]) será usada em vez disso.
...
<p>O Protocolo de Identificação não é destinado como um protocolo de autorização ou controle de acesso.</p>
</td>
<td valign="top" width="10%">
</td>
</tr>
