...
O reescritor de consultas é discutido em detalhes no [Capítulo 39][(rules.md "Chapter 39. The Rule System")], então não há necessidade de cobrir isso aqui. Apenas vamos ressaltar que tanto a entrada quanto a saída do reescritor são árvores de consulta, ou seja, não há mudança na representação ou no nível de detalhe semântico nas árvores. A reescrita pode ser vista como uma forma de expansão de macro.