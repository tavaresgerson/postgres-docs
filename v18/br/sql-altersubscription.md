...
Veja [Notas](sql-createsubscription.md#SQL-CREATESUBSCRIPTION-NOTES) para obter detalhes sobre como o `copy_data = true` pode interagir com o parâmetro [`origin`](sql-createsubscription.md#SQL-CREATESUBSCRIPTION-PARAMS-WITH-ORIGIN).
