...
+ [7.8.3. Materialização de Expressão de Tabela Comum](queries-with.md#QUERIES-WITH-CTE-MATERIALIZATION)
+ [7.8.4. Declarações que modificam dados em `WITH`](queries-with.md#QUERIES-WITH-MODIFYING)

Os capítulos anteriores explicaram como criar tabelas, como preencher elas com dados e como manipular esses dados. Agora, finalmente, discutiremos como recuperar os dados do banco de dados.