...
<p>Nome do wrapper de dados estrangeiros</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Proprietário do wrapper de dados estrangeiros</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Faz referência a uma função de manipulador que é responsável por fornecer rotinas de execução para o wrapper de dados externos. Zero se nenhum manipulador for fornecido</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Faz referência a uma função de validação responsável por verificar a validade das opções fornecidas ao wrapper de dados externos, bem como as opções para servidores externos e mapeamentos de usuários usando o wrapper de dados externos. Zero se nenhum validador for fornecido</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Opções específicas para wrappers de dados estrangeiros, como<span class="quote">“<span class="quote">palavra-chave=valor</span>”</span>cordas</p>
</td>
</tr>
</tbody>
</table>
