## 45.6. Exemplos [#](#SPI-EXAMPLES)

Esta seção contém um exemplo muito simples de uso do SPI. A função C `execq` recebe um comando SQL como seu primeiro argumento e um número de linhas como seu segundo, executa o comando usando `SPI_exec` e retorna o número de linhas que foram processadas pelo comando. Você pode encontrar exemplos mais complexos para SPI na árvore de origem em `src/test/regress/regress.c` e no módulo [spi](contrib-spi.md "F.41. spi — Server Programming Interface features/examples") .
