...
<p>O OID do banco de dados ao qual o ajuste se aplica, ou zero, se não for específico do banco de dados</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>O OID do papel ao qual o ajuste se aplica, ou zero, se não for específico para o papel.</p>
</td>
</tr>
<tr>
<td class="catalog_table_entry">
...
<p>Defeitos para variáveis de configuração de tempo de execução</p>
</td>
</tr>
</tbody>
</table>
