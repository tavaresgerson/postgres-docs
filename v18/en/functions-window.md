...
The built-in window functions are listed in [Table 9.67](functions-window.md#FUNCTIONS-WINDOW-TABLE "Table 9.67. General-Purpose Window Functions"). Note that these functions *must* be invoked using window function syntax, i.e., an `OVER` clause is required.
