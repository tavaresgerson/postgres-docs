...
The catalog `pg_index` contains part of the information about indexes. The rest is mostly in [`pg_class`](catalog-pg-class.md "52.11. pg_class").
   ...
   <td class="catalog_table_entry">
    ...
    <p>
     ...
     operations, but it cannot safely
       be used for queries. If it is unique, the uniqueness property is not guaranteed true either.
    </p>
   </td>
  </tr>
  <tr>
   <td class="catalog_table_entry">
    ...
    <p>
     ...
     with incompatible rows that they can see
    </p>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   <td class="catalog_table_entry">
    ...
    <p>
     ...
     values that indicate which table columns this index indexes.  For example, a value of
     <code class="literal">
      1 3
     </code>
  ...
  <tr>
   <td class="catalog_table_entry">
    ...
    <p>
     ...
     representation) for index attributes that are not simple column references.  This is a list with one element for each zero entry in
     <code class="structfield">
      indkey
     </code>
