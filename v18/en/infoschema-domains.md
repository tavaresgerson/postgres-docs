...
The view `domains` contains all [*[domains](glossary.md#GLOSSARY-DOMAIN "Domain")*](glossary.md#GLOSSARY-DOMAIN) defined in the current database. Only those domains are shown that the current user has access to (by way of being the owner or having some privilege).
