...
*`with_query`*: The `WITH` clause allows you to specify one or more subqueries that can be referenced by name in the `DELETE` query. See [Section 7.8](queries-with.md "7.8. WITH Queries (Common Table Expressions)") and [SELECT](sql-select.md "SELECT") for details.
