...
The system view [`pg_file_settings`](view-pg-file-settings.md "53.8. pg_file_settings") can be helpful for pre-testing changes to the configuration files, or for diagnosing problems if a SIGHUP signal did not have the desired effects.
...
In addition, the system view [`pg_settings`](view-pg-settings.md "53.25. pg_settings") can be used to view and change session-local values:
