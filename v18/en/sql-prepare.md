...
*`statement`*: Any `SELECT`, `INSERT`, `UPDATE`, `DELETE`, `MERGE`, or `VALUES` statement.
...
You can see all prepared statements available in the session by querying the [`pg_prepared_statements`](view-pg-prepared-statements.md "53.16. pg_prepared_statements") system view.
