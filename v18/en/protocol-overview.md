...
[Table 54.1](protocol-overview.md#PROTOCOL-VERSIONS-TABLE "Table 54.1. Protocol Versions") shows the currently supported protocol versions.
  ...
  <tr>
   ...
   <td>
    Current latest version. The secret key used in query
        cancellation was enlarged from 4 bytes to a variable length field. The BackendKeyData message was changed to accommodate that, and the CancelRequest message was redefined to have a variable length payload.
   </td>
  </tr>
  <tr>
   <td>
   ...
   <td>
    Reserved. Version 3.1 has not been used by any PostgreSQL
        version, but it was skipped because old versions of the popular pgbouncer application had a bug in the protocol negotiation which made it incorrectly claim that it supported version 3.1.
   </td>
  </tr>
  <tr>
   <td>
