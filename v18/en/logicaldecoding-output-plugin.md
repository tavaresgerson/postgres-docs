...
An example output plugin can be found in the [`contrib/test_decoding`](test-decoding.md "F.45. test_decoding — SQL-based test/example module for WAL logical decoding") subdirectory of the PostgreSQL source tree.
