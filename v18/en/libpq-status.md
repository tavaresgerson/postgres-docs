...
`PQdb` [#](#LIBPQ-PQDB): Returns the database name of the connection.

``` char *PQdb(const PGconn *conn);
    ```

`PQuser` [#](#LIBPQ-PQUSER): Returns the user name of the connection.
...
:   Returns the password of the connection.
    ...
    file](libpq-pgpass.md "32.16. The Password File"), it will return that. In the latter case,
...
`PQfullProtocolVersion` [#](#LIBPQ-PQFULLPROTOCOLVERSION)
