 ...
 <tbody>
  ...
  <tr>
   <td class="func_table_entry">
    ...
    <p>
     Removes adjacent duplicates. Often used with
     <code class="function">
      sort
     </code>
 ...
 <tbody>
  ...
  <tr>
   <td class="func_table_entry">
    ...
    <p>
     Returns index of the first array element matching the right argument, or 0 if no match. (Same as
     <code class="function">
      idx
     </code>
     function.)
...
All work was done by Teodor Sigaev (`<teodor@sigaev.ru>`) and Oleg Bartunov (`<oleg@sai.msu.su>`). See
<http://www.sai.msu.su/~megera/postgres/gist/> for
additional information. Andrey Oktyabrski did a great work on adding new functions and operations.
