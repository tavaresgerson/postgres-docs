...
*`name`*: The name of the conversion. The conversion name can be schema-qualified.

`CASCADE` `RESTRICT`: These key words do not have any effect, since there are no dependencies on conversions.
