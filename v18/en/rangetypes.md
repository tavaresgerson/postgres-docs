...
See [Table 9.58](functions-range.md#RANGE-OPERATORS-TABLE "Table 9.58. Range Operators") and [Table 9.60](functions-range.md#RANGE-FUNCTIONS-TABLE "Table 9.60. Range Functions") for complete lists of operators and functions on range types.
...
A GiST or SP-GiST index on ranges can accelerate queries involving these range operators: `=`, `&&`, `<@`, `@>`, `<<`, `>>`, `-|-`, `&<`, and `&>`. A GiST index on multiranges can accelerate queries involving the same set of multirange operators. A GiST index on ranges and GiST index on multiranges can also accelerate queries involving these cross-type range to multirange and multirange to range operators correspondingly: `&&`, `<@`, `@>`, `<<`, `>>`, `-|-`, `&<`, and `&>`. See [Table 9.58](functions-range.md#RANGE-OPERATORS-TABLE "Table 9.58. Range Operators") for more information.
