...
and thesaurus dictionaries ([Section 12.6.4](textsearch-dictionaries.md#TEXTSEARCH-THESAURUS "12.6.4. Thesaurus Dictionary")).
...
stored generated columns, as described in [Section 12.2.2](textsearch-tables.md#TEXTSEARCH-TABLES-INDEX "12.2.2. Creating Indexes").
