...
:   The Tcl script contained in *`command`* is
    ...
    See [Section 42.9](pltcl-subtransactions.md "42.9. Explicit Subtransactions in PL/Tcl") for more details and an
    example.
...
:   Emits a log or error message. Possible levels are
    ...
    variables. See [Chapter 19](runtime-config.md "Chapter 19. Server Configuration")
    and [Section 42.8](pltcl-error-handling.md "42.8. Error Handling in PL/Tcl")
