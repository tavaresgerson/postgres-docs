...
Generated columns can also be specified in a column list. This allows generated columns to be published, regardless of the publication parameter [`publish_generated_columns`](sql-createpublication.md#SQL-CREATEPUBLICATION-PARAMS-WITH-PUBLISH-GENERATED-COLUMNS). See [Section 29.6](logical-replication-gencols.md "29.6. Generated Column Replication") for details.
