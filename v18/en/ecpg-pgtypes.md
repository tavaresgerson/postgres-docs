...
`PGTYPESnumeric_new` [#](#ECPG-PGTYPES-NUMERIC-NEW): Request a pointer to a newly allocated numeric variable.

``` numeric *PGTYPESnumeric_new(void);
    ```

`PGTYPESnumeric_free` [#](#ECPG-PGTYPES-NUMERIC-FREE): Free a numeric type, release all of its memory.
...
date. See [Section 8.5](datatype-datetime.md "8.5. Date/Time Types") for the equivalent type in the
PostgreSQL server.
...
:   Convert a variable of type date to its textual representation using a
    ...
    * `mmm` - The name of the month (abbreviated).
    ...
    [Table 34.3](ecpg-pgtypes.md#ECPG-PGTYPESDATE-FMT-ASC-EXAMPLE-TABLE "Table 34.3. Valid Input Formats for PGTYPESdate_fmt_asc") indicates a few possible formats. This will give
...
:   Use a format mask to convert a C `char*` string to a value of type
    ...
    [Table 34.4](ecpg-pgtypes.md#ECPG-RDEFMTDATE-EXAMPLE-TABLE "Table 34.4. Valid Input Formats for rdefmtdate") indicates a few possible formats. This will give
...
type timestamp. See [Section 8.5](datatype-datetime.md "8.5. Date/Time Types") for the equivalent
...
type interval. See [Section 8.5](datatype-datetime.md "8.5. Date/Time Types") for the equivalent
type in the PostgreSQL server.
...
Informix compatibility mode described in [Section 34.15](ecpg-informix-compat.md "34.15. Informix Compatibility Mode").
