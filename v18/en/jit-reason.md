...
Tuple deforming is the process of transforming an on-disk tuple (see [Section 66.6.1](storage-page-layout.md#STORAGE-TUPLE-LAYOUT "66.6.1. Table Row Layout")) into its in-memory representation. It can be accelerated by creating a function specific to the table layout and the number of columns to be extracted.
