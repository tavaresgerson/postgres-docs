...
1 quotation mark [#](#PLPGSQL-QUOTE-TIPS-1-QUOT): To begin and end the function body, for example:
...
2 quotation marks [#](#PLPGSQL-QUOTE-TIPS-2-QUOT): For string literals inside the function body, for example:
...
:   When you want two single quotation marks in a string constant (which
    ...
    [Example 41.10](plpgsql-porting.md#PLPGSQL-PORTING-EX2 "Example 41.10. Porting a Function that Creates Another Function from PL/SQL to PL/pgSQL").
    For example:
