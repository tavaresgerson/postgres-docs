...
The data types of all the *`result`* expressions must be convertible to a single output type. See [Section 10.5](typeconv-union-case.md "10.5. UNION, CASE, and Related Constructs") for more details.
