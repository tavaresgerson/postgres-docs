...
`PQclientEncoding` [#](#LIBPQ-PQCLIENTENCODING): Returns the client encoding.
...
`PQsetClientEncoding` [#](#LIBPQ-PQSETCLIENTENCODING): Sets the client encoding.
...
:   Enables tracing of the client/server communication to a debugging file
    ...
    [Section 54.7](protocol-message-formats.md "54.7. Message Formats").
