...
For matching of single names, returned text arrays can be matched directly using the `&&` operator: any overlap can be considered a match. A GIN index may be used for efficiency, see [Section 65.4](gin.md "65.4. GIN Indexes") and this example:
