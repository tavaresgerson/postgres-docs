...
The translations from internal enum values to textual labels are kept in the system catalog [`pg_enum`](catalog-pg-enum.md "52.20. pg_enum"). Querying this catalog directly can be useful.
