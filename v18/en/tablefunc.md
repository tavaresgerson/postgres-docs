...
[Table F.33](tablefunc.md#TABLEFUNC-FUNCTIONS "Table F.33. tablefunc Functions") summarizes the functions provided by the `tablefunc` module.
...
[Table F.34](tablefunc.md#TABLEFUNC-CONNECTBY-PARAMETERS "Table F.34. connectby Parameters") explains the parameters.
