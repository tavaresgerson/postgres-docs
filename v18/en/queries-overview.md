...
The process of retrieving or the command to retrieve data from a database is called a *query*. In SQL the [`SELECT`](sql-select.md "SELECT") command is used to specify queries. The general syntax of the `SELECT` command is
