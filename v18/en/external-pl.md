...
PostgreSQL includes several procedural languages with the base distribution: [PL/pgSQL](plpgsql.md "Chapter 41. PL/pgSQL — SQL Procedural Language"), [PL/Tcl](pltcl.md "Chapter 42. PL/Tcl — Tcl Procedural Language"), [PL/Perl](plperl.md "Chapter 43. PL/Perl — Perl Procedural Language"), and [PL/Python](plpython.md "Chapter 44. PL/Python — Python Procedural Language").
