  ...
  <tr>
   <td class="func_table_entry">
    ...
    <p>
     ...
     is negative, subpath starts that far from the end of the path. If
     <em class="parameter">
      <code>
       len
      </code>
  ...
  <tr>
   <td class="func_table_entry">
    ...
    <p>
     ...
     , or -1 if not found.  The search starts at position
     <em class="parameter">
      <code>
       offset
      </code>
...
All work was done by Teodor Sigaev (`<teodor@stack.net>`) and Oleg Bartunov (`<oleg@sai.msu.su>`). See
<http://www.sai.msu.su/~megera/postgres/gist/> for
additional information. Authors would like to thank Eugeny Rodichev for helpful discussions. Comments and bug reports are welcome.
