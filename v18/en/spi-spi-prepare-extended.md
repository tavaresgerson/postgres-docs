...
`ParserSetupHook parserSetup`: Parser hook setup function

`void * parserSetupArg`: pass-through argument for *`parserSetup`*

`RawParseMode parseMode`: mode for raw parsing; `RAW_PARSE_DEFAULT` (zero) produces default behavior
