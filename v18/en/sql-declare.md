...
*`query`*: A [`SELECT`](sql-select.md "SELECT") or [`VALUES`](sql-values.md "VALUES") command which will provide the rows to be returned by the cursor.
...
You can see all available cursors by querying the [`pg_cursors`](view-pg-cursors.md "53.7. pg_cursors") system view.
