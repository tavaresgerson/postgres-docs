...
`TRUNCATE` can be used for foreign tables if supported by the foreign data wrapper, for instance, see [postgres_fdw](postgres-fdw.md "F.38. postgres_fdw — access data stored in external PostgreSQL servers").
