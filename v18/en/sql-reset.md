...
*`configuration_parameter`*: Name of a settable run-time parameter. Available parameters are documented in [Chapter 19](runtime-config.md "Chapter 19. Server Configuration") and on the [SET](sql-set.md "SET") reference page.
