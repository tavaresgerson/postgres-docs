...
Details of the `pg_locks` view appear in [Section 53.13](view-pg-locks.md "53.13. pg_locks"). For more information on locking and managing concurrency with PostgreSQL, refer to [Chapter 13](mvcc.md "Chapter 13. Concurrency Control").
