...
`error`: used to highlight the text “error” in error messages

`warning`: used to highlight the text “warning” in warning messages

`note`: used to highlight the text “detail” and “hint” in such messages

`locus`: used to highlight location information (e.g., program name and file name) in messages
