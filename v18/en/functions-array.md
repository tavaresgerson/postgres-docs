...
[Table 9.57](functions-array.md#ARRAY-FUNCTIONS-TABLE "Table 9.57. Array Functions") shows the functions available for use with array types. See [Section 8.15](arrays.md "8.15. Arrays") for more information and examples of the use of these functions.
