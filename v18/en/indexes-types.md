...
(See [Section 9.11](functions-geometry.md "9.11. Geometric Functions and Operators") for the meaning of these operators.) The GiST operator classes included in the standard distribution are documented in [Table 65.1](gist.md#GIST-BUILTIN-OPCLASSES-TABLE "Table 65.1. Built-in GiST Operator Classes"). Many other GiST operator classes are available in the `contrib` collection or as separate projects. For more information see [Section 65.2](gist.md "65.2. GiST Indexes").
...
which finds the ten places closest to a given target point. The ability to do this is again dependent on the particular operator class being used. In [Table 65.1](gist.md#GIST-BUILTIN-OPCLASSES-TABLE "Table 65.1. Built-in GiST Operator Classes"), operators that can be used in this way are listed in the column “Ordering Operators”.
...
(See [Section 9.11](functions-geometry.md "9.11. Geometric Functions and Operators") for the meaning of these operators.) The SP-GiST operator classes included in the standard distribution are documented in [Table 65.2](spgist.md#SPGIST-BUILTIN-OPCLASSES-TABLE "Table 65.2. Built-in SP-GiST Operator Classes"). For more information see [Section 65.3](spgist.md "65.3. SP-GiST Indexes").

Like GiST, SP-GiST supports “nearest-neighbor” searches. For SP-GiST operator classes that support distance ordering, the corresponding operator is listed in the “Ordering Operators” column in [Table 65.2](spgist.md#SPGIST-BUILTIN-OPCLASSES-TABLE "Table 65.2. Built-in SP-GiST Operator Classes").
...
(See [Section 9.19](functions-array.md "9.19. Array Functions and Operators") for the meaning of these operators.) The GIN operator classes included in the standard distribution are documented in [Table 65.3](gin.md#GIN-BUILTIN-OPCLASSES-TABLE "Table 65.3. Built-in GIN Operator Classes"). Many other GIN operator classes are available in the `contrib` collection or as separate projects. For more information see [Section 65.4](gin.md "65.4. GIN Indexes").
...
The BRIN operator classes included in the standard distribution are documented in [Table 65.4](brin.md#BRIN-BUILTIN-OPCLASSES-TABLE "Table 65.4. Built-in BRIN Operator Classes"). For more information see [Section 65.5](brin.md "65.5. BRIN Indexes").
