...
[[5]](#id-1.4.5.6.9.5) There are options to define the window frame in other ways, but this tutorial does not cover them. See [Section 4.2.8](sql-expressions.md#SYNTAX-WINDOW-FUNCTIONS "4.2.8. Window Function Calls") for details.
