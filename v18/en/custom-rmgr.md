...
An extension, especially a [Table Access Method](tableam.md "Chapter 62. Table Access Method Interface Definition") or [Index Access Method](indexam.md "Chapter 63. Index Access Method Interface Definition"), may need to use WAL for recovery, replication, and/or [Logical Decoding](logicaldecoding.md "Chapter 47. Logical Decoding").
