...
Operator classes are associated with an index access method, such as [B-Tree](btree.md "65.1. B-Tree Indexes") or [GIN](gin.md "65.4. GIN Indexes"). Custom index access method may be defined with [CREATE ACCESS METHOD](sql-create-access-method.md "CREATE ACCESS METHOD"). See [Chapter 63](indexam.md "Chapter 63. Index Access Method Interface Definition") for details.
...
GiST indexes have twelve support functions, seven of which are optional, as shown in [Table 36.11](xindex.md#XINDEX-GIST-SUPPORT-TABLE "Table 36.11. GiST Support Functions"). (For more information see [Section 65.2](gist.md "65.2. GiST Indexes").)
...
SP-GiST indexes have six support functions, one of which is optional, as shown in [Table 36.12](xindex.md#XINDEX-SPGIST-SUPPORT-TABLE "Table 36.12. SP-GiST Support Functions"). (For more information see [Section 65.3](spgist.md "65.3. SP-GiST Indexes").)
...
GIN indexes have seven support functions, four of which are optional, as shown in [Table 36.13](xindex.md#XINDEX-GIN-SUPPORT-TABLE "Table 36.13. GIN Support Functions"). (For more information see [Section 65.4](gin.md "65.4. GIN Indexes").)
...
BRIN indexes have five basic support functions, one of which is optional, as shown in [Table 36.14](xindex.md#XINDEX-BRIN-SUPPORT-TABLE "Table 36.14. BRIN Support Functions"). Some versions of the basic functions require additional support functions to be provided. (For more information see [Section 65.5.3](brin.md#BRIN-EXTENSIBILITY "65.5.3. Extensibility").)
...
Another SQL feature that requires even more data-type-specific knowledge is the `RANGE` *`offset`* `PRECEDING`/`FOLLOWING` framing option for window functions (see [Section 4.2.8](sql-expressions.md#SYNTAX-WINDOW-FUNCTIONS "4.2.8. Window Function Calls")). For a query such as
